<li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= BASE_URL ?>/dist/img/<?= isLoggedIn() ? $user->user_image : 'generic.png' ?>" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?= isLoggedIn() ? $user->user_name : 'Guest' ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?= isLoggedIn() ? $user->user_name : 'Guest' ?>
                  <small><?= isLoggedIn() ? date("M jS Y", strtotime($user->user_joinedAt)) : '' ?></small>
                  <small><?= isLoggedIn() ? ucfirst($user->user_role) : '' ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">
