...
!(function (t, e) {
  ...
  (() => {
        ...
        return t.length ?
            k(t).reduce(
              function (t, o) {
                var n = y(t);
                return (
                  e(y(n), o) ? (n[n.length] = o) : (t[t.length] = [o]),
                  t
                );
              },
              [[b(t)]],
    ...
    function W(t) {
      ...
      return (
        0 === e ||
        (!T(t) && 1 === e && t.innerHTML === M) ||
        !(!C.all(t.childNodes, T) || "" !== t.innerHTML)
      );
    }
    function K(t) {
    ...
    function at(t) {
      if (t.nextSibling && t.parent === t.nextSibling.parent)
        return T(t.nextSibling) ? t.nextSibling : at(t.nextSibling);
    }
    function st(t, e) {
        ...
        (e = [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                !i && this[r] ? this[r].apply(this, e)
                : a && a[r] && a.shouldInitialize() ? a[r].apply(a, e)
                : void 0
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              (null !== t.contents && this.$editable.html(t.contents),
                null !== t.bookmark &&
                  Tt.createFromBookmark(this.editable, t.bookmark).select());
            },
          },
          {
            key: "rewind",
            ...
            value: function (t) {
              ...
              try {
                o = r().extend(o, {
                  ...
                  "font-italic":
                    document.queryCommandState("italic") ? "italic" : "normal",
                  "font-underline":
                    document.queryCommandState("underline") ? "underline" : (
                      "normal"
                    ),
                  "font-subscript":
                    document.queryCommandState("subscript") ? "subscript" : (
                      "normal"
                    ),
                  "font-superscript":
                    document.queryCommandState("superscript") ? "superscript"
                    : "normal",
                  "font-strikethrough":
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t, e) {
              e = (e = (e =
                e || Tt.create(t)).deleteContents()).wrapBodyInlineWithPara();
              var o,
    ...
    var Gt = function t(e, o, n, i) {
      ...
      function d(t, e) {
        ...
        var s =
          e.attributes.rowSpan ? parseInt(e.attributes.rowSpan.value, 10) : 0;
        if (s > 1)
          for (var c = 1; c < s; c++) {
            var d = t.rowIndex + c;
        ...
        var h =
          e.attributes.colSpan ? parseInt(e.attributes.colSpan.value, 10) : 0;
        if (h > 1)
          for (var p = 1; p < h; p++) {
            ...
            ((this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.insertNode = this.wrapCommand(function (t) {
                o.isLimited(r()(t).text().length) ||
                  ...
                  o.setLastRange(Tt.createFromNodeAfter(t).select()));
              })),
              ...
              (this.insertHorizontalRule = this.wrapCommand(function () {
                ...
                t.nextSibling &&
                  o.setLastRange(
                    Tt.create(t.nextSibling, 0).normalize().select(),
                  );
              })),
              ...
              (this.removeMedia = this.wrapCommand(function () {
                ...
                : (t = r()(o.restoreTarget()).detach()),
                  o.setLastRange(Tt.createFromSelection(t).select()),
          ...
          (e = [
            ...
            },
            {
              ...
              value: function (t) {
                t ?
                  (this.lastRange = t)
                : ((this.lastRange = Tt.create(this.editable)),
                  0 ===
                    r()(this.lastRange.sc).closest(".note-editable").length &&
                    (this.lastRange = Tt.createFromBodyElement(this.editable)));
              },
            },
            {
              key: "getLastRange",
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  t.isOnAnchor() &&
                    (t = Tt.createFromNode(pt.ancestor(t.sc, pt.isAnchor))),
                  t.toString()
                );
              },
            },
                ...
                if ("" !== o) {
                  ...
                  if (
                    ...
                    i &&
                      ...
                      Tt.createFromNode(i.firstChild).select(),
                      this.setLastRange(),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  e.length && (o.isNewWindow = "_blank" === e.attr("target")),
                  o
                );
              },
            },
        ...
        (e = [
          {
            ...
            value: function (t) {
              ...
              e &&
                (t ?
                  o ? this.$codable.data("cmEditor").getDoc().setValue(t)
                  : this.$codable.val(t)
              ...
              value: function () {
                if (this.lastWordRange) {
                  ...
                  if (e && (e[1] || e[2])) {
                    var o = e[1] ? t : "http://" + t,
                      n =
                        this.options.showDomainOnlyForAutolink ?
                          t
                            .replace(
              ...
              if (this.lastWord) {
                ...
                this.options.match(e, function (e) {
                  if (e) {
                    var o = "";
                    if (
                      ("string" == typeof e ? (o = pt.createText(e))
          ...
          },
          {
            ...
            value: function (t) {
              this.$popover.is(":visible") &&
                ...
                : t.keyCode === Nt.code.UP ? (t.preventDefault(), this.moveUp())
        ...
        ui_template: function (t) {
          return {
            ...
            createLayout: function (e) {
              var o = (
                t.airMode ? Qo([Go([Zo(), Jo()])])
                : "bottom" === t.toolbarPosition ?
                  Vo([Go([Zo(), Yo()]), _o(), Xo()])
                : Vo([_o(), Go([Zo(), Yo()]), Xo()])).render();
              return (
                o.insertAfter(e),
                {
                  note: e,
